...
# os.chdir(r"C:\Users\LENOVO\AMIT AI\Amit-1\myenv\Scripts\Final Project BME\Brain-Tumor-Segmentation-using-UNET-Transformer-computer-vision-main")
...
def load_dataset(path, split=0.1):
    ...
    print(f"Found {len(X)} images and {len(Y)} masks")
...
if __name__ == "__main__":
    ...
    """ Dataset """
    dataset_path = r"C:\Users\LENOVO\AMIT AI\Amit-1\myenv\Scripts\Final Project BME\Brain-Tumor-Segmentation-using-UNET-Transformer-computer-vision-main\Brain-Tumor-Segmentation-using-UNET-Transformer-computer-vision-main\brain tumor segmentation"
